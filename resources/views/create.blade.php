            ...
            <div class="col-md-10  col-md-offset-1">
              ...
              <h1>New product</h1>
                  ...
                  <div class="form-group">
      							...
      							<input type="number" step="0.01" class="form-control" name="per_hour" placeholder="0.00" required></textarea>
      						</div>

                  <div class="form-group">
                    <label for="per_day">Price per day:</label>
                    <input type="number" step="0.01" class="form-control" name="per_day" placeholder="0.00" required></textarea>
                  </div>

                  <div class="form-group">
                    <label for="per_day">Product image:</label>
                    <input type="text" name="image_link" class="form-control" placeholder="Place link to product image..." required></textarea>
                  </div>
