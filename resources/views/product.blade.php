    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-md-offset-2">
                <div class="row">
                    <div class="thumbnail">
                        <img src="/images/{{$product->image_link}}" alt="" class="img-responsive">
                        <div class="caption" style="height:auto">
                          <h4 class="pull-right"><a href="{{ route('product.products', $product->user->id )}}">{{ucfirst($product->user->name)}}</a></h4>
                            <h4><a href="{{route('product.show', $product->id)}}">{{$product->title}}</a></h4>
                            <small><p><a href="{{route('product.category',strtolower($product->category->id))}}">{{$product->category->title}}</a></p></small>
